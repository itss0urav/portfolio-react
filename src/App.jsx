    ...
    <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
      <div className="mx-auto max-w-2xl">
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <h1 className="text-4xl font-bold text-center mb-4">Sourav S</h1>
          <p className="text-gray-600 text-center mb-8">
            I am a web developer based in Kerala, India, with a keen interest in
            creating dynamic and interactive web applications. I have a passion
            for exploring new technologies and am committed to continually
            learning and enhancing my skills.
          </p>
          <div className="space-y-5">
            <h3 className="text-lg font-semibold">Languages and Tools:</h3>
        ...
        <div className="flex gap-8">
          {/* Anywhere Project */}
          <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow p-5">
            <img
            ...
            />
            <div className="p-4">
              <a href="https://github.com/itss0urav/Anywhere2.0">
                <h5 className="mb-2 text-2xl font-bold text-gray-900">
                  Anywhere
                </h5>
              </a>
              <p className="mb-4 text-gray-700">
                Anywhere/Anywhere 2.0 is a web application designed to foster a
                sense of community and encourage meaningful discussions among
                its users.
              </p>
              <a
