    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center  animate-fade-in-down">
      ...
      <div className=" min-h-screen py-6 flex flex-col justify-center sm:py-12 z-10">
        <div className="mx-auto max-w-[80%]">
                ...
                <div className="flex flex-wrap gap-4">
                  <a target="blank" href="https://www.w3.org/html/">
                    <img
                      ...
                      alt="HTML5"
                      className=" hover:neon-cyan hover:bg-cyan-500 w-16"
                    />
                  </a>
          ...
          <div className="mt-8">
            <div className="text-4xl text-center mb-4 font-bold neon-blue rounded-md p-1 bg-gradient-to-r from-fuchsia-200 to-sky-500 bg-clip-text text-transparent text-opacity-100">
              GitHub Repos
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {repos.map((repo) => (
                <div
                  key={repo.id}
                  className="rounded overflow-hidden shadow-lg p-4 bg-violet-300 bg-opacity-30 neon-sky"
                >
                  <div className="flex justify-center hover:bg-sky-400 rounded-md neon-sky">
                    <a
                      href={repo.html_url}
            ...
            <div className="text-center mt-3 ">
              <a
                ...
                className="text-white text-xl neon-sky p-2 text-center rounded-md text-opacity-100"
              >
                Message Me
              </a>
            </div>
